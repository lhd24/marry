...
function(a, b) {
	...
	function g(c, d) {
		...
		for (var e = [], f = !1, g = {
		    ...
		    if (b('<section class="main-page" rel="' + c[h - 1].timeline + '"><div class="m-img" id="page' + h + '"></div></section>').appendTo("#nr"), (10 == j && ($("#page" + h).parent(".main-page").wrap('<div class="flip-mask" id="flip' + h + '"></div>'))), c.length > 1 && (0 == j || 1 == j || 8 == j || 2 == j ? b('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'images/btn01_arrow.png" /></section>').appendTo("#page" + h) : (3 == j || 4 == j || 5 == j || 9 == j || 10 == j) && b('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'images/btn01_arrow_right.png" /></section>').appendTo("#page" + h)), 1 == h && (b(".loading").hide(), b(".main-page").eq(0).addClass("z-current")), c[h - 1].properties && !b.isEmptyObject(c[h - 1].properties) ? c[h - 1].properties.image || c[h - 1].properties.scratch ? p.scratch ? addScratchEffect(c, h) : !
		function(a) {
